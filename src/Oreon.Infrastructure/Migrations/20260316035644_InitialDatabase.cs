        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LookingFor = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Messages_Members_RecipientMemberId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserLikes", x => new { x.SourceMemberId, x.TargetMemberId });
                    table.ForeignKey(
                        name: "FK_UserLikes_Members_SourceMemberId",
                        column: x => x.SourceMemberId,
                        principalTable: "Members",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserLikes_Members_TargetMemberId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Messages_RecipientMemberId",
                table: "Messages",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserLikes_SourceMemberId",
                table: "UserLikes",
                column: "SourceMemberId");

            migrationBuilder.CreateIndex(
                name: "IX_UserLikes_TargetMemberId",
                table: "UserLikes",
